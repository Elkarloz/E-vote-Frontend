                        ...
                        <div class="form-group row mx-auto" >
                            ...
                            <div class="col-md-3">
                                <select class="form-control my-2" required v-model="datos.JorCodigo">
                                    <option hidden value="" selected>-- Seleciona una Jornada --</option>
                                    <option v-for="(item, index) in comboBox3" :key="index">{{item.JorNombre}}</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <select class="form-control my-2" required v-model="datos.ProforNombre">
                                    ...
                                    <option v-for="(item, index) in comboBox2" :key="index" >{{item.ProforNombre}}</option>
                                </select>
                            </div>
                             <div class="col-md-3">
                                <select class="form-control my-2" required v-model="datos.TipdocNombre" >
                                    ...
                                    <option v-for="(item, index) in comboBox1" :key="index" >{{item.TipdocNombre}}</option>
                                </select>
                            </div>
